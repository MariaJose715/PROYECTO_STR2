...
/**
 * wifi_event_handler()
 * Manejador de eventos WiFi (patrón de los ejemplos station y softAP de ESP-IDF).
 */
...
void wifi_init(void)
{
    ...
    // Inicializar TCP/IP y event loop
    ...
    // Esperar conexión Station (no bloqueante, con timeout)
